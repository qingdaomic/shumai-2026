...
const BASICS_BY_TOPIC = {
  ...
  quad_eq:[
    ...
    {id:"b_qeq_39",diff:2,content:"解方程：x²-8x+15=0",answer:"x=3 或 x=5",sol:"①将方程分解因式：(x-3)(x-5)=0 ②令每个因式为零：x-3=0 或 x-5=0 ③解得 x=3 或 x=5",error:"找因数对时符号易错",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_40",diff:2,content:"解方程：x²+4x+3=0",answer:"x=-1 或 x=-3",sol:"①将方程分解因式：(x+1)(x+3)=0 ②令每个因式为零：x+1=0 或 x+3=0 ③解得 x=-1 或 x=-3",error:"两个负根容易漏掉负号",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_41",diff:2,content:"解方程：x²-3x-10=0",answer:"x=5 或 x=-2",sol:"①将方程分解因式：(x-5)(x+2)=0 ②令每个因式为零：x-5=0 或 x+2=0 ③解得 x=5 或 x=-2",error:"符号不同的因数对，积为负数",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_42",diff:2,content:"解方程：x²-49=0",answer:"x=7 或 x=-7",sol:"①利用平方差公式分解：(x-7)(x+7)=0 ②令每个因式为零：x-7=0 或 x+7=0 ③解得 x=7 或 x=-7",error:"平方差公式，别漏掉负根",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_43",diff:2,content:"解方程：x²-x-2=0",answer:"x=2 或 x=-1",sol:"①将方程分解因式：(x-2)(x+1)=0 ②令每个因式为零：x-2=0 或 x+1=0 ③解得 x=2 或 x=-1",error:"找两数积-2、和-1，注意符号",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_44",diff:2,content:"解方程：x²+10x+25=0",answer:"x=-5",sol:"①将方程分解为完全平方：(x+5)²=0 ②开平方得 x+5=0 ③解得 x=-5",error:"完全平方式只有一个根，不要写两个",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_45",diff:2,content:"解方程：2x²+5x-3=0",answer:"x=1/2 或 x=-3",sol:"①将方程分解因式：(2x-1)(x+3)=0 ②令每个因式为零：2x-1=0 或 x+3=0 ③解得 x=1/2 或 x=-3",error:"首项系数不为1时十字相乘要验证",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_46",diff:2,content:"解方程：3x²-10x+3=0",answer:"x=1/3 或 x=3",sol:"①将方程分解因式：(3x-1)(x-3)=0 ②令每个因式为零：3x-1=0 或 x-3=0 ③解得 x=1/3 或 x=3",error:"非标准系数十字相乘，注意内外积之和",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_47",diff:2,content:"解方程：x²-2x=0",answer:"x=0 或 x=2",sol:"①提取公因式：x(x-2)=0 ②令每个因式为零：x=0 或 x-2=0 ③解得 x=0 或 x=2",error:"不能两边除以x，否则漏掉x=0",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_48",diff:2,content:"解方程：4x²-25=0",answer:"x=5/2 或 x=-5/2",sol:"①利用平方差公式分解：(2x-5)(2x+5)=0 ②令每个因式为零：2x-5=0 或 2x+5=0 ③解得 x=5/2 或 x=-5/2",error:"两侧系数都要处理，结果是分数根",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_49",diff:2,content:"解方程：x²-6x+8=0",answer:"x=2 或 x=4",sol:"①将方程分解因式：(x-2)(x-4)=0 ②令每个因式为零：x-2=0 或 x-4=0 ③解得 x=2 或 x=4",error:"找两数积=8、和=-6",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_50",diff:2,content:"解方程：x²+2x-15=0",answer:"x=3 或 x=-5",sol:"①将方程分解因式：(x-3)(x+5)=0 ②令每个因式为零：x-3=0 或 x+5=0 ③解得 x=3 或 x=-5",error:"找两数积=-15、和=2，符号相反",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_51",diff:2,content:"解方程：x²-4x-5=0",answer:"x=5 或 x=-1",sol:"①将方程分解因式：(x-5)(x+1)=0 ②令每个因式为零：x-5=0 或 x+1=0 ③解得 x=5 或 x=-1",error:"找两数积=-5、和=-4",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_52",diff:2,content:"解方程：2x²-3x+1=0",answer:"x=1 或 x=1/2",sol:"①将方程分解因式：(2x-1)(x-1)=0 ②令每个因式为零：2x-1=0 或 x-1=0 ③解得 x=1/2 或 x=1",error:"非标准系数，十字相乘验证内外积",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_53",diff:2,content:"解方程：x²+9x+20=0",answer:"x=-4 或 x=-5",sol:"①将方程分解因式：(x+4)(x+5)=0 ②令每个因式为零：x+4=0 或 x+5=0 ③解得 x=-4 或 x=-5",error:"两根都是负数，积正和正",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_54",diff:2,content:"解方程：x²-12x+36=0",answer:"x=6",sol:"①将方程分解为完全平方：(x-6)²=0 ②开平方得 x-6=0 ③解得 x=6",error:"完全平方式只有一个二重根",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_55",diff:2,content:"解方程：5x²-x=0",answer:"x=0 或 x=1/5",sol:"①提取公因式：x(5x-1)=0 ②令每个因式为零：x=0 或 5x-1=0 ③解得 x=0 或 x=1/5",error:"提公因式后x=0是根，不可漏",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_56",diff:2,content:"解方程：x²-5x=0",answer:"x=0 或 x=5",sol:"①提取公因式：x(x-5)=0 ②令每个因式为零：x=0 或 x-5=0 ③解得 x=0 或 x=5",error:"不能两边同除以x，漏掉x=0",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_57",diff:2,content:"解方程：2x²+x-6=0",answer:"x=3/2 或 x=-2",sol:"①将方程分解因式：(2x-3)(x+2)=0 ②令每个因式为零：2x-3=0 或 x+2=0 ③解得 x=3/2 或 x=-2",error:"非标准系数十字相乘，符号验证",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qeq_58",diff:2,content:"解方程：x²+6x+9=0",answer:"x=-3",sol:"①将方程分解为完全平方：(x+3)²=0 ②开平方得 x+3=0 ③解得 x=-3",error:"完全平方式唯一根，注意根为负数",upLink:["tg02","tg03"],downLink:[]},
  ],
  equations:[
  ...
  <text x="75" y="150" fill="#fbbf24" font-size="11" font-family="sans-serif">同号必过！</text>
    ...
    {id:"b_lfu_37",diff:2,content:"已知一次函数y=3x-5，求斜率k和y轴截距b",answer:"k=3，b=-5",sol:"①一次函数标准形式y=kx+b，k是斜率，b是y轴截距 ②对比y=3x-5得k=3 ③b=-5",error:"对比标准形式直接读出，注意b为负数",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_38",diff:2,content:"将直线方程2x+y-4=0化成y=kx+b的形式，求斜率k和截距b",answer:"k=-2，b=4",sol:"①移项得y=-2x+4 ②对比y=kx+b，k=-2 ③b=4",error:"先移项整理成y=kx+b形式",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_39",diff:2,content:"已知一次函数图像经过(0,2)和(1,5)，求斜率k",answer:"k=3",sol:"①斜率公式k=(y₂-y₁)/(x₂-x₁) ②代入：(5-2)/(1-0)=3 ③斜率k=3",error:"斜率公式分子分母顺序要一致",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_40",diff:2,content:"已知直线y=-x+7，求斜率k和x轴截距",answer:"k=-1，x轴截距为7",sol:"①斜率k=-1 ②令y=0：-x+7=0，x=7 ③x轴截距为7",error:"x轴截距令y=0，不是令x=0",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_41",diff:2,content:"已知一次函数y=(2/3)x-1，求斜率k和y轴截距b",answer:"k=2/3，b=-1",sol:"①从y=(2/3)x-1直接看出k=2/3 ②b=-1",error:"分数斜率直接读出，注意b的符号",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_42",diff:2,content:"判断点(2,5)是否在直线y=2x+1上",answer:"在",sol:"①将x=2代入：右边=2×2+1=5 ②y值等于点的纵坐标5 ③点在直线上",error:"代入x验证y值是否与点坐标相等",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_43",diff:2,content:"判断点(-1,4)是否在直线y=-3x+2上",answer:"不在",sol:"①将x=-1代入：右边=-3×(-1)+2=5 ②得y=5，不等于点的纵坐标4 ③点不在直线上",error:"负数代入注意负负得正，-3×(-1)=3",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_44",diff:2,content:"已知直线y=(1/2)x-3，判断点(4,-1)是否在该直线上",answer:"在",sol:"①代入x=4：右边=(1/2)×4-3=2-3=-1 ②结果y=-1与点纵坐标一致 ③点在直线上",error:"(1/2)×4=2，再减3得-1",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_45",diff:2,content:"已知一次函数图像经过A(1,3)和B(2,5)，求函数解析式",answer:"y=2x+1",sol:"①k=(5-3)/(2-1)=2 ②设y=2x+b，代入(1,3)：3=2+b→b=1 ③y=2x+1",error:"先求k再代入一点求b",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_46",diff:2,content:"求经过点(-2,1)和(0,-3)的直线方程",answer:"y=-2x-3",sol:"①k=(-3-1)/(0-(-2))=-4/2=-2 ②(0,-3)为y轴截距点，b=-3 ③y=-2x-3",error:"第二个点是y轴截距点，可直接得b",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_47",diff:2,content:"已知一次函数经过(3,0)和(-1,4)，求解析式",answer:"y=-x+3",sol:"①k=(4-0)/(-1-3)=4/(-4)=-1 ②设y=-x+b，代入(3,0)：0=-3+b→b=3 ③y=-x+3",error:"斜率为负，注意分母-1-3=-4不要算错",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_48",diff:2,content:"求经过点(4,7)和(6,11)的直线解析式",answer:"y=2x-1",sol:"①k=(11-7)/(6-4)=4/2=2 ②设y=2x+b，代入(4,7)：7=8+b→b=-1 ③y=2x-1",error:"求b时：7=8+b，b=7-8=-1，注意符号",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_49",diff:2,content:"求直线y=4x-8与x轴和y轴的交点坐标",answer:"x轴交点(2,0)，y轴交点(0,-8)",sol:"①令y=0：4x-8=0→x=2，x轴交点(2,0) ②令x=0：y=-8，y轴交点(0,-8)",error:"分别令y=0和x=0，不要混淆",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_50",diff:2,content:"求直线y=-2x+6与x轴、y轴的交点坐标",answer:"x轴交点(3,0)，y轴交点(0,6)",sol:"①令y=0：-2x+6=0→x=3，交点(3,0) ②令x=0：y=6，交点(0,6)",error:"令y=0解方程求x轴截距",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_51",diff:2,content:"求直线y=3x+1与x轴的交点坐标",answer:"(-1/3, 0)",sol:"①令y=0：3x+1=0 ②3x=-1，x=-1/3 ③交点(-1/3,0)",error:"x轴截距可以是分数，注意符号为负",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_52",diff:2,content:"求直线2x+3y=6与x轴和y轴的交点坐标",answer:"x轴交点(3,0)，y轴交点(0,2)",sol:"①令y=0：2x=6→x=3，交点(3,0) ②令x=0：3y=6→y=2，交点(0,2)",error:"先各令一个变量为零",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_53",diff:2,content:"将y=2x-1的图像向上平移3个单位，求新的解析式",answer:"y=2x+2",sol:"①向上平移3个单位，截距b增加3 ②b=-1+3=2，斜率不变 ③新解析式y=2x+2",error:"上下平移只改变截距b，斜率k不变",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_54",diff:2,content:"将直线y=-x+4的图像向右平移2个单位，求新解析式",answer:"y=-x+6",sol:"①向右平移2，x用(x-2)替换：y=-(x-2)+4 ②展开：y=-x+2+4=-x+6 ③新解析式y=-x+6",error:"右移2用(x-2)替换x，展开后截距增加2",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_55",diff:2,content:"将y=3x的图像向左平移5个单位，求新解析式",answer:"y=3x+15",sol:"①向左平移5，x用(x+5)替换：y=3(x+5) ②展开：y=3x+15 ③新解析式y=3x+15",error:"左移5用(x+5)替换x，展开后截距增加15",upLink:["tg01","tg14"],downLink:[]},
    {id:"b_lfu_56",diff:2,content:"将y=(1/2)x-3的图像向下平移4个单位，求新解析式",answer:"y=(1/2)x-7",sol:"①向下平移4，截距b减少4：b=-3-4=-7 ②斜率不变，仍为1/2 ③新解析式y=(1/2)x-7",error:"向下平移截距减小，不要加成-3+4",upLink:["tg01","tg14"],downLink:[]},
  ],
  inverse_fn:[
  ...
  <text x="40" y="165" fill="#dce8f8" font-size="12" font-family="sans-serif">-1&lt;x&lt;3 时 y&lt;0</text>
    ...
    {id:"b_qfu_40",diff:2,content:"求二次函数y=-x²+2x+4的顶点坐标",answer:"顶点(1,5)",sol:"①提取负号配方：y=-(x²-2x)+4=-(x²-2x+1-1)+4=-(x-1)²+1+4 ②化简得y=-(x-1)²+5 ③顶点(1,5)",error:"a<0时先提负号再配方，注意常数项调整",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qfu_41",diff:2,content:"求二次函数y=2x²+8x+5的顶点坐标",answer:"顶点(-2,-3)",sol:"①提公因式：y=2(x²+4x)+5 ②配方：y=2(x²+4x+4-4)+5=2(x+2)²-8+5=2(x+2)²-3 ③顶点(-2,-3)",error:"提系数后配方，-4×2=-8注意常数项",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qfu_42",diff:2,content:"判断二次函数y=-3x²+x-2的开口方向",answer:"开口向下",sol:"①二次函数y=ax²+bx+c中a决定开口方向 ②此题a=-3 ③a<0，所以抛物线开口向下",error:"a的符号决定开口方向，a<0向下",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qfu_43",diff:2,content:"判断二次函数y=(1/2)x²-4的开口方向",answer:"开口向上",sol:"①二次项系数a=1/2 ②a=1/2>0 ③抛物线开口向上",error:"分数系数也适用，正数即向上",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qfu_44",diff:2,content:"求二次函数y=x²+6x-1的对称轴",answer:"对称轴x=-3",sol:"①对称轴公式x=-b/(2a) ②a=1，b=6，代入：x=-6/(2×1)=-3 ③对称轴x=-3",error:"对称轴公式分母是2a，别写成2",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qfu_45",diff:2,content:"求二次函数y=-2x²+8x+1的对称轴",answer:"对称轴x=2",sol:"①x=-b/(2a) ②a=-2，b=8，代入：x=-8/(2×(-2))=-8/(-4)=2 ③对称轴x=2",error:"a为负数时分母2a也为负，负负得正",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qfu_46",diff:2,content:"求二次函数y=-x²+10的对称轴",answer:"对称轴x=0（即y轴）",sol:"①x=-b/(2a) ②a=-1，b=0，代入：x=-0/(2×(-1))=0 ③对称轴x=0，即y轴",error:"b=0时对称轴是y轴",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qfu_47",diff:2,content:"求二次函数y=x²-2x-3与x轴的交点坐标",answer:"交点(3,0)和(-1,0)",sol:"①令y=0：x²-2x-3=0 ②分解：(x-3)(x+1)=0 ③x=3或x=-1，交点(3,0)和(-1,0)",error:"令y=0解方程，两根即两个交点横坐标",upLink:["tg02","tg03"],downLink:[]},
    {id:"b_qfu_48",diff:2,content:"求二次函数y=x²-6x+9与x轴的交点坐标",answer:"交点(3,0)，只有一个",sol:"①令y=0：x²-6x+9=0 ②完全平方：(x-3)²=0 ③x=3，抛物线与x轴只有一个交点(3,0)",error:"完全平方式Δ=0，与x轴只有一个切点",upLink:["tg02","tg03"],downLink:[]},
  ],
  tri_basic:[
