...
const BASICS_BY_TOPIC = {
  ...
  <text x="75" y="150" fill="#fbbf24" font-size="11" font-family="sans-serif">同号必过！</text>
    ...
    {id:"b_lfu_22",diff:1,content:"直线y=x+2与y轴的交点坐标",answer:"(0,2)",sol:"①令x=0：y=2；②交点(0,2)",error:"与y轴交点令x=0",upLink:["tg01","tg14"],downLink:[]},
    ...
    {id:"b_lfu_29",diff:2,content:"y=ax+b，当a=2，b=-1时，函数的零点（x轴截距）",answer:"x=1/2",sol:"①令y=0：2x-1=0；②x=1/2",error:"零点即令y=0",upLink:["tg01","tg14"],downLink:[]},
  ...
  <text x="40" y="165" fill="#dce8f8" font-size="12" font-family="sans-serif">-1&lt;x&lt;3 时 y&lt;0</text>
    ...
    {id:"b_qfu_23",diff:1,content:"y=x²，x=3时y=？",answer:"y=9",sol:"①代入x=3：y=9",error:"基础代入计算",upLink:["tg02","tg03"],downLink:[]},
    ...
    {id:"b_qfu_27",diff:2,content:"二次函数y=ax²+bx+c，开口向下，a的范围",answer:"a<0",sol:"①开口向下→a<0",error:"a>0开口向上，a<0开口向下",upLink:["tg02","tg03"],downLink:[]},
